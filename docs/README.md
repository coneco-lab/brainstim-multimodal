...
- [`interesting-links.md`](interesting-links.md) contains a commented list of pointers to supplementary materials that go deeper into data analysis and computing topics
- [`why-python.md`](why-python.md) provides a permanent answer to a question that some have asked and might ask again in the future
